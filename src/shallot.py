...
class ShallotHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        try:
            ...
            flags, next_ip, next_port, next_header = crypto.decode_header(header, prikey.private_bytes_raw())
    ...
    def _handle_intermediate(self, next_ip: str, next_port: int, next_header: bytes, payload: bytes) -> None:
        """
    ...
    def _handle_recipient(self, next_ip: str, next_port: int, next_header: bytes, payload: bytes) -> None:
        """
